...
<script runat="server">
    ...
    private bool CheckAuthentication()
    {
        ...
        SageFrame.Web.SageUserControl objSageControl = new SageFrame.Web.SageUserControl();
        SageFrame.Framework.SecurityPolicy objSecurity = new SageFrame.Framework.SecurityPolicy();
        FormsAuthenticationTicket ticket = objSecurity.GetUserTicket(objSageControl.GetPortalID);
        if (ticket != null && ticket.Name != SageFrame.Framework.ApplicationKeys.anonymousUser)
        {
            return true;
        }
        else
