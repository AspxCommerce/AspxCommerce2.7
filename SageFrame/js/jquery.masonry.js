        ...
        */
        Outlayer.prototype._layoutItems = function (items, isInstant) {
            ...
            for (var i = 0, len = items.length; i < len; i++) {
                ...
                var position = this._getItemLayoutPosition(item, index);
                // enqueue
                position.item = item;
...
function (items, value) {
    ...
    this.containerWidth;
        ...
        Masonry.prototype._getItemLayoutPosition = function (item,itempos) {
            item.getSize();
            ...
            if (!this.options.EnableSorting) {
                minimumY = colGroup[itempos];
                shortColIndex=itempos;
            } else {
                 minimumY = Math.min.apply(Math, colGroup);
                shortColIndex= indexOf(colGroup, minimumY);
            }
