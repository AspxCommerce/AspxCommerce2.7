...
jQuery.fn.gzoom = function(settings) {
    ...
    return this.each(function() {
        ...
        function drawIface() {
            ...
            $('body').append('<div id="gzoomoverlay"></div><div id="gzoomlbox"><div id="imagebox"><div class="cssClassCloseIcon"> <button class="cssClassClose" type="button"> <span>Close</span></button> </div>  <div id="gzoom-cont-img"><img id="zoomedimage"><div id="gzoomloading"><a href="#" id="gzoomloadinglink"><img src="' + AspxCommerce.utils.GetAspxTemplateFolderPath() + '/images/ajax-loader.gif"></a></div></div></div><div id="gzoomlbox-con-imgdata"><div id="lboximgdatacontainer"><div id="gzoomlbox-image-details"><span id="gzoom-image-caption"></span></div></div></div></div>');
