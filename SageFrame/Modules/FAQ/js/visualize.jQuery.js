    ...
    $.fn.visualize = function(options, container) {
        return $(this).each(function() {
            ...
            var o = $.extend({
                ...
                height: 350, //height of canvas - defaults to table height
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
                rowFilter: ' ',
                colFilter: ' ',
                colors: ['#793688', '#97D95C', '#DF28EF', '#ee8310', '#8d10ee', '#5a3b16', '#26a4ed', '#f45a90', '#e9e744'],
...
//                            }
            ...
            var canvasContain = (container || $('<div id="divVisualize" class="visualize" role="img" aria-label="Chart representing data from the table: ' + title + '" />'))
			.height(o.height)
			.width(o.width)
			.append(canvas);
            ...
            if (o.appendTitle || o.appendKey) {
                var infoContain = $('<div class="visualize-info" style="display:none"></div>')
