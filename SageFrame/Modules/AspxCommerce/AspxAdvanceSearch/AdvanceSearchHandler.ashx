<%@ WebHandler Language="C#" Class="AdvanceSearchHandler" %>
...
public class AdvanceSearchHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.AdvanceSearch.AdvanceSearchController), json, methodName);
