<%@ WebHandler Language="C#" Class="AIMHandler" %>
...
public class AIMHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AuthorizeNetAIM.AIMController), json, methodName);
