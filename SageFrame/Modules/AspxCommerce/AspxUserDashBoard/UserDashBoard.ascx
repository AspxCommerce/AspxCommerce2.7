    ...
    <div class="cssClassCommonSideBox">
        ...
        <div class="cssClasMyAccount">
            <ul class="cssClassMyDashBoard">
                <li><a href="javascript:void(0);" name="AccountDashBoard" class="cssClassmyAccountActive sfLocale">Account Dashboard</a></li>
                <li><a href="javascript:void(0);" name="AddressBook" class="sfLocale">Address Book</a></li>
                <li><a href="javascript:void(0);" name="MyOrders" class="sfLocale">My Orders</a></li>
                <li><a href="javascript:void(0);" name="MyReturns" class="sfLocale">My Returns</a></li>
                <li><a href="javascript:void(0);" name="MyRewardPoints" id="MyRewardPoints" class="sfLocale">My Reward Points</a></li>
                <li><a href="javascript:void(0);" name="MyItemReviews" class="sfLocale">My Item Reviews</a></li>
                <li><a href="javascript:void(0);" name="MyTags" class="sfLocale">My Tags</a></li>
                <li><a href="javascript:void(0);" name="MyWishList" class="sfLocale">My Wishlist</a></li>
                <li><a href="javascript:void(0);" name="SharedWishList" class="sfLocale">Shared Wishlist</a></li>
                <li><a href="javascript:void(0);" name="MyDownloadableItems" class="sfLocale">My Digital Items</a></li>
                <li><a href="javascript:void(0);" name="ReferredFriends" class="sfLocale">Referred Friends</a></li>
                <li><a href="javascript:void(0);" name="RecentHistory" class="sfLocale">Recent History</a></li>
                <li><a href="javascript:void(0);" name="GiftCard" class="sfLocale">Gift Card</a></li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript" id="tst">
    ...
    var RewardPointsGeneralSettingsIsActive = '<%=RewardPointsGeneralSettingsIsActive %>';
    ...
    var IsRewardInstl = '<%=IsRewardInstl %>'
