<%@ WebHandler Language="C#" Class="AspxServiceItemsHandler" %>
...
public class AspxServiceItemsHandler : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest (HttpContext context) {
        try
        {
                ...
                ServiceProcesser process = new ServiceProcesser(typeof(AspxCommerce.Core.AspxServiceController), json, methodName);
